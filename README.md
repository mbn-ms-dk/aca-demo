...
# You can echo out the individual values
# You 'only' need ACR_NAME, IDENTITY_ID and KEYVAULT_NAME if using bicep deployment
...
KEYVAULT_NAME=$(echo $DEPLOY_OUTPUTS | jq -r .kvName.value)
```
